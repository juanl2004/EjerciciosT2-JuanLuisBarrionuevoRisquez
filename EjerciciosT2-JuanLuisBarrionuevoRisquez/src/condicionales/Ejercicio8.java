...
public class Ejercicio8 {
	...
	public static void main(String[] args) {
		...
		double precioTotal;
		// Declaramos el precioDesc para guardar el precio del billete con el descuento
		// aplicado.
		double precioDesc;
		...
		// Calculamos el precio total, multiplicando la distancia por el 2,5 (el precio
		// por km)
		precioTotal = distancia * 2.5;

		// Comprobamos sii la distancia es mayor que 800 y el número de dias es mayor
		// que 7
		if (distancia > 800 && ndias > 7) {
			// Calculamos el precio con el descuento del 30%, para ello multiplicamos 0,3
			// por el precio total y el resultado se lo restamos al precio total.
