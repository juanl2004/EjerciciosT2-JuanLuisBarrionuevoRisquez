 ...
 * ENTRADA: 29587038 | RES. ESPERADO: 29587038E | RES. OBTENIDO: 29587038E
 */
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		...
		// Condición para comprobar que el número introducido esta comprendido entre
		// 00000000 y 99999999.
		if (dni >= 00000000 && dni <= 99999999) {

			// Hacemos el mudulo del dni y comparamos todos los casos posibles, y el que se
			// de se imprimira.
			switch (dni % 23) {
		...
		// Si no se da la condición del if
		} else { 
